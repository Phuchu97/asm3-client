...
function CheckoutComponent() {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            name: Yup.string().min(6, 'Tối thiểu 6 ký tự').required('Trường này là bắt buộc!'),
            email: Yup
                .string()
    ...
    const handleDeleteCart = (id) => {
        deleteListCart((res) => {
            if (res.statusCode === 200) {
                toast.success("Xóa thành công!", { className: 'toast-message' });
                handleGetCart();
            } else {
                toast.error("Có lỗi trong quá trình xử lý!", { className: 'toast-message' });
            }
    ...
    return (
        <div className="checkout">
            ...
            <div className="checkout-header row">
                <div className='col-12 col-md-6 checkout-header-div-title'>
            ...
            <div className="checkout-content row">
                <div className="col-12 col-lg-8 checkout-content-left">
                    <h3 className="checkout-content-left-title">CHI TIẾT THANH TOÁN</h3>
                    <form onSubmit={formik.handleSubmit}>
                        <div className="checkout-form">
                            <label htmlFor="name" className="checkout-label-input">Họ và tên:</label>
                            <input
                                id="name"
                                name="name"
                ...
                <div className="col-12 col-lg-4 checkout-content-right">
